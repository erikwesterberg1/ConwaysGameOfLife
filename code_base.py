...
STATE_RIM, STATE_DEAD, STATE_ALIVE = '#', '-', ' '  # base cell states
...
def get_print_value(_val: str) -> str:
    ...
    def get_state_color(state):
        ...
        switcher = {
            STATE_RIM: '\033[47m',          # Magenta background color
            STATE_DEAD: '\033[30m',         # Red foreground color
            STATE_ALIVE: '\033[107m',        # Cyan foreground color
